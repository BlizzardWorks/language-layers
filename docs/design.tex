...
\usepackage{hyperref}
\usepackage{fontspec}
\setmainfont[BoldFont={Cardo Bold}, ItalicFont={Cardo Italic}]{Cardo}
...
\label{sec:org48a038f}

\subsubsection{Foreword}
\label{sec:org56836b2}
...
\subsection{Font testing: Cardo + SBL Hebrew}
\label{sec:orgabdc866}
