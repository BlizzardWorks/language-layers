...
\label{sec:org9fadcbc}

\subsection{What is this project?}
\label{sec:org030306b}
...
\label{sec:org16e9bbd}

\subsubsection{Justifying design choices}
\label{sec:org2c7dae0}
...
\subsection{Unicode}
\label{sec:org2f59988}

\subsubsection{History}
\label{sec:org096ebcc}
...
\label{sec:orgfb544e8}

\subsection{Letters}
\label{sec:org504bf26}
...
\label{sec:org2bbf8c0}

\subsubsection{Final sigma}
\label{sec:orgc97947d}
...
\label{sec:org3e1e6e6}

\subsubsection{Diaeresis}
\label{sec:orgf454343}
